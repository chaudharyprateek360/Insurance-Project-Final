...
namespace VehicleInsuranceProject.Models
{
    ...
    public partial class db_ProjectGladiatorEntities : DbContext
    {
        ...
        public virtual int usp_DeactivatePolicy(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_DeactivatePolicy", idParameter);
        }
    }
}
